...
class AuthController
{
    ...
    public function login()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            //    - Jika verifikasi password salah, set session message "Login Gagal NIM atau Password Salah"
                ...
                $_SESSION['message'] = "Password Salah atau NIM Salah";
    ...
    private function generateNIM($id_pendaftaran){
        ...
        if ($kode_jurusan != 0) {
            $nim = $kode_jurusan + $tahunmasuk + $id_pendaftaran.str_pad($id_pendaftaran['id'],2,'0',STR_PAD_LEFT);
            return $nim;
        }
        else {
            return false;
    ...
    public function register_step_1()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $query = "SELECT * FROM mahasiswa WHERE id_pendaftaran = '$id_pendaftaran' ADD STATUS 'lulus'";
